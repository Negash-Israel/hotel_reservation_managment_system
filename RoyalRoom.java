...
public class RoyalRoom extends HotelRoom {
	final float price=2500f;
	 ...
	 public RoyalRoom(String customerName,String customerAddress,String phoneNo,String email, int roomNo,int numberOfRoom)
	 {
	 ...
	 public void menu() throws IOException {
			...
			do {
				...
				System.out.println("welcome to royal hotel room");
	 ...
	 public void addCustomer() {
			...
			email=input.next();
			 ...
			 try {
				 ...
				 if (file!=null) {
					 ...
					 file.createNewFile();
		         FileWriter Fl=new FileWriter("royalroom.txt",true);
		       BufferedWriter f_writer= new BufferedWriter(Fl);
		      f_writer.write(" "+customerName);
		      f_writer.write(" "+customerAddress);
		      f_writer.write(" "+phoneNo);
		      f_writer.write(" "+email);
		      f_writer.write(" "+roomNo);
		      f_writer.write(" "+price);
		      f_writer.write(" "+numberOfRoom);
		      f_writer.write(" the price   "+calculatePrice());
		...
		public int cheekRoomNumber() {
			int flag=0;
			File file = new File("royalroom.txt");
		    try {
		       System.out.println("=====================================================");
